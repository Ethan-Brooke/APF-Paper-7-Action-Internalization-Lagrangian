...
> Brooke, E. S. (2026). *Action, Internalization, and the Lagrangian*. Version v2.0. Zenodo. https://doi.org/10.5281/zenodo.18604875

**BibTeX:**

```bibtex
@misc{brooke_paper7_2026,
...
The DOI `10.5281/zenodo.18604875` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
