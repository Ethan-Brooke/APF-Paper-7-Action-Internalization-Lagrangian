...
**Summary:** APF makes 48 testable predictions across particle physics, electroweak physics, and cosmology. All predictions are parameter-free (no adjustment); the only inputs are the codebase v6.8 checks (frozen 2026-04-18; `verify_all.py` reports 48 predictions and 348 checks total).
